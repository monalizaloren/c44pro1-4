...
//Nas linhas acima, você está programando a seta para cima
//Faça o mesmo para as setas direita e esquerda




showRank() {
  //Utilize o código 'swal', pois ele cria uma notificação personalizada
  ???({
    title: `Incrível!${"\n"}Rank${"\n"}${player.rank}`,
